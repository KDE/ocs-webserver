...
function tplVarMapFunc($n)
{
    return '/%' . $n . '%/';
}

class Default_Plugin_SendMail extends Zend_Controller_Plugin_Abstract
{
    ...
    public function setTemplate($tplName)
    {
        ...
        $mailTplTable = new Default_Model_DbTable_MailTemplate();
        $mailTpl = $mailTplTable->findBy('name', $tplName);
        $mailTpl = $mailTpl->toArray();
    ...
    public function send()
    {
        try {
            ...
            $mail->setBodyHtml($this->buildBodyHtml());
...
EOT;
    ...
    private function replaceVars()
    {
        ...
        $suchmuster = array_map('tplVarMapFunc', array_keys($this->_tplVars));
