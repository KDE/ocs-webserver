 ...
 **/
class Default_View_Helper_BuildSearchTagUrl
{
     ...
     * @return string
     */
    public function buildSearchTagUrl($searchstring, $action = '', $params = null, $withHost = false, $scheme = null)
    {
        ...
        return "{$host}/{$storeId}search/projectSearchText/{$searchstring}/f/tags/{$action}{$url_param}";
    }
