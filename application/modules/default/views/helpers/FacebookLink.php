...
class Default_View_Helper_FacebookLink extends Zend_View_Helper_Abstract
{

    public function facebookLink($strLink)
    {
    ...
    {
        if ((strpos($strUrl, 'facebook') !== false)
            OR (strpos($strUrl, 'fb.me') !== false)
