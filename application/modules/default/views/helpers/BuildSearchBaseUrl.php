 ...
 **/
class Default_View_Helper_BuildSearchBaseUrl
{
     ...
     * @return string
     */
    public function buildSearchBaseUrl($params = null, $withHost = false, $scheme = null)
    {       
        ...
        return "{$host}/{$storeId}search/projectSearchText/";
    }
