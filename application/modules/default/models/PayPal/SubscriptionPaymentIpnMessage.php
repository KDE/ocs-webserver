...
class Default_Model_PayPal_SubscriptionPaymentIpnMessage extends Local_Payment_PayPal_SubscriptionPayment_Ipn
{
    ...
    {
        $this->_tableSupport->activateSupportSubscriptionSignupFromResponse($this->_ipnMessage);
    }
