 ...
 **/
class Default_Model_DbTable_VCategory extends Local_Model_Table
{

    const ORDERED_TITLE = 'title';
    const ORDERED_ID = 'v_category_id';
    const ORDERED_HIERARCHIC = 'lft';

    protected $_keyColumnsForRow = array('v_category_id','v_parent_id');

    protected $_key = 'v_category_id';

    /**
     * @var string
     */
    protected $_name = "v_category";
    /** @var  Zend_Cache_Core */
    protected $cache;
    ...
    {
        $selectArr = $this->_db->fetchAll('SELECT v_category_id, title FROM v_category ORDER BY v_category_id');

        $arrayModified = array();

        $arrayModified[0] = "ProjectAddFormCatSelect";
        foreach ($selectArr as $item) {
            $arrayModified[$item['v_category_id']] = stripslashes($item['title']);
        }
    ...
    {
        $selectArr = $this->_db->fetchAll('SELECT v_category_id, title FROM project_category ORDER BY v_category_id');
