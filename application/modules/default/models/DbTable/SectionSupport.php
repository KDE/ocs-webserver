...
class Default_Model_DbTable_SectionSupport extends Zend_Db_Table_Abstract
{
     ...
     */
    public function createNewSectionSupport($support_id, $section_id, $amount, $tier, $period, $period_frequency, $project_id = null, $member_id = null, $project_category_id = null, $referer = null)
    {
