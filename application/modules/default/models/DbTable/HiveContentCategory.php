...
class Default_Model_DbTable_HiveContentCategory extends Local_Model_Table
{
     ...
     * @return Num of rows
     **/
    public function fetchCountPlingProjectsForCategory($category_id)
    {
    ...
    {
    	$resultSet = $this->queryPlingCategories();
    	return $resultSet;
    }
    ...
    {
    	$result = $this->queryPlingCategory($cat_id);
    	return $result;
    }
     ...
     * @return array
     */
    private function queryPlingCategory($id)
    {
     ...
     * @return array
     */
    private function queryPlingCategories()
    {
