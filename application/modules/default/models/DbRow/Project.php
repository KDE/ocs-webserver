 ...
 **/
class Default_Model_DbRow_Project extends Zend_Db_Table_Row_Abstract implements Local_Db_Table_Row_ValidateInterface
{
    ...
    public function setVerifiedStatus($status)
    {
        ...
        if (false === $this->isConnected()) {
            $this->setTable(new Default_Model_DbTable_Project());
        }
        return parent::save();
    }
