 ...
 **/
class DonateController extends Local_Controller_Action_DomainSwitch
{
    ...
    public function payAction()
    {
        ...
        //amount predefined or custom?
        $toggle_custom = $this->getParam('toggle_custom');
