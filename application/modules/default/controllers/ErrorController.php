    ...
    public function loginAction()
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            $this->_helper->json(array(
                ...
                'message'   => '<p>Your session may be outdated or authorization is required. Please <strong><a href="'
                    . $loginUri
                    . '">login</a></strong> or <strong><a href="/register">register</a></strong> to get access to this function/page.</p>',
                'login_url' => $loginUri
            ));
        }
    }
