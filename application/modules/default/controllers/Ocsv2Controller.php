 ...
 */
class Ocsv2Controller extends Zend_Controller_Action
{
    ...
    protected $_config = array(
        'id' => 'opendesktop.org',
        'location' => 'https://www.opendesktop.org/ocs/v2/',
    ...
    public function personcheckAction()
    {
        ...
        else if (!$this->_authenticateUser($identity, $credential)) {
