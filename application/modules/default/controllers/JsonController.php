...
class JsonController extends Zend_Controller_Action
{
    ...
    public function chatAction()
    {
        ...
        $urlRooms = JsonController::chat_roomPublicUrl.'?access_token='.JsonController::chat_access_token;
