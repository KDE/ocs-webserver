 ...
 **/
class Default_Form_Collection extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement($this->getTitleElement())
            ...
            // ->addElement($this->getUserCategoryElement())
...
//        $validatorRegEx = new Zend_Validate_Regex(array('pattern' => "/^[ \/\[\]\.\-_A-Za-z0-9'\pL]{1,}$/iu")); // with unicode character class
        ...
        return $this->createElement('text', 'title')
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_title.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getCategoryIdElement()
    {
        ...
        return $this->createElement('number', 'project_category_id', array())
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_cat_id.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getDescriptionElement()
    {
        return $this->createElement('textarea', 'description', array('cols' => 30, 'rows' => 9))
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_description.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getUserCategoryElement()
    {
        return $this->createElement('textarea', 'user_category', array('cols' => 30, 'rows' => 9))
                    ->setRequired(false)
                    ->setFilters(array('StringTrim'))
                    ->setDecorators(array(
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_user_category.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getVersionElement()
    {
        return $this->createElement('text', 'version')
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_version.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getSmallImageElement()
    {
        return $this->createElement('hidden', 'image_small')
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_image_small.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getImageUploadElement()
    {
        ...
        return $this->createElement('file', 'image_small_upload')
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_image_small_upload.phtml',
                        'placement'  => false
                    )
                )
    ...
    private function getEmbedCodeElement()
    {
        return $this->createElement('textarea', 'embed_code', array('cols' => 30, 'rows' => 3))
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_embedcode.phtml',
                        'placement'  => false
                    )
                )
            ))
        ...
        return $this->createElement('text', 'link_1', array())
                    ...
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_link.phtml',
                                'placement'  => false
                            )
                        )
                    ))
        ...
        return $this->createElement('text', 'source_url', array())
                    ...
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_source_url.phtml',
                                'placement'  => false
                            )
                        )
                    ))
        ...
        return $this->createElement('text', 'facebook_code', array())
                    ...
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_facebook.phtml',
                                'placement'  => false
                            )
                        )
                    ))
        ...
        return $this->createElement('text', 'twitter_code', array())
                    ...
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_twitter.phtml',
                                'placement'  => false
                            )
                        )
                    ))
        ...
        return $this->createElement('text', 'google_code', array())
                    ...
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_google.phtml',
                                'placement'  => false
                            )
                        )
                    ))
    ...
    private function getTagElement()
    {
        ...
        return $element->setFilters(array('StringTrim'))->setDecorators(array(
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_tags_multiselect.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getTagUserElement()
    {
        ...
        return $element->setFilters(array('StringTrim'))->setDecorators(array(
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_tags_user.phtml',
                        'placement'  => false
                    )
                )
            ))
        ...
        return $this->createElement('hidden', 'project_id')->setFilters(array('StringTrim'))->addValidators(array('Digits'))
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_hidden.phtml',
                                'placement'  => false
                            )
                        )
                    ))
    ...
    private function getLicenseIdElement()
    {
        ...
        return $element->setFilters(array('StringTrim'))->setMultiOptions($options)->setDecorators(array(
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_select_license.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getGitlabProjectId()
    {
        ...
        return $element->setFilters(array('StringTrim'))->setMultiOptions($optionArray)->setDecorators(array(
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_gitlab_project_id.phtml',
                        'placement'  => false
                    )
                )
            ))
        ...
        return $this->createElement('number', 'amount', array())
                    ...
                    ->setDecorators(array(
                        array(
                            'ViewScript',
                            array(
                                'viewScript' => 'collection/viewscripts/input_amount.phtml',
                                'placement'  => false
                            )
                        )
                    ))
    ...
    private function getAmountPeriodElement()
    {
        return $this->createElement('radio', 'amount_period', array())
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_amount_period.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getBigImageElement()
    {
        return $this->createElement('hidden', 'image_big')
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_image_big.phtml',
                        'placement'  => false
                    )
                )
            ))
    ...
    private function getBigImageUploadElement()
    {
        ...
        return $this->createElement('file', 'image_big_upload')->setDisableLoadDefaultDecorators(true)
                ...
                array(
                    'ViewScript',
                    array(
                        'viewScript' => 'collection/viewscripts/input_image_big_upload.phtml',
                        'placement'  => false
                    )
                )
