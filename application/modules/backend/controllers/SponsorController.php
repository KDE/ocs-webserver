 ...
 **/
class Backend_SponsorController extends Local_Controller_Action_Backend
{
    ...
    protected $_modelName = 'Default_Model_DbTable_Sponsor';
    ...
    {
        $groupId = (int)$this->getParam('sponsor_id', null);

        $this->_model->delete(array('sponsor_id = ?' => $groupId));
    ...
    public function allsponsorsAction()
    {
        ...
        try {
                ...
                foreach ($resultRows as $row) {         
                    $resultForSelect[] = array('DisplayText' => $row['name'].'['.$row['sponsor_id'].']', 'Value' => $row['sponsor_id']);
                }
