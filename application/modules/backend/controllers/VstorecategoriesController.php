 ...
 **/
class Backend_VstorecategoriesController extends Local_Controller_Action_Backend
{
    ...
    protected $_modelName = 'Default_Model_DbTable_VConfigStoreCategory';
    protected $_pageTitle = 'Manage Virtual Store Categories';
