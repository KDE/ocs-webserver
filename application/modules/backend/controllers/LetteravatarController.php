...
class Backend_LetteravatarController extends Local_Controller_Action_Backend
{
    ...
    public function listAction()
    {
        ...
        $reports = $this->_model ->getMembersAvatarOldAutogenerated($sorting,(int)$pageSize,$startIndex);        
        $totalRecordCount = $this->_model ->getMembersAvatarOldAutogeneratedTotalCount();
