 ...
 **/
class Backend_VcategoriesController extends Local_Controller_Action_Backend
{
    const RESULT_OK = "OK";
    ...
    protected $_modelName = 'Default_Model_DbTable_VCategory';
    ...
    public function init()
    {
        ...
        $this->view->pageTitle = 'Manage Virtual Categories';
