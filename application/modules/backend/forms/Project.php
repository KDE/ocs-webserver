...
class Backend_Form_Project extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $video = $this->createElement('textarea', 'embed_code', array('cols' => 30, 'rows' => 3))
            ...
            ->setRequired(false)
            ->setAttrib('placeholder', '<iframe src="https://www.youtube.com/embed/XXXXXXXX" style="width:641px;height:360px;" width="641" height="360" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>')
