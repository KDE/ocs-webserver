...
class Backend_Model_Group
{
    ...
    public function addLdapGroupMember($group_name, $user_username, $group_access, $group_id, $group_path)
    {
        $modelLdap = new Default_Model_Ocs_Ldap();
        $modelLdap->addGroupMember($user_username, $group_name, $group_access, $group_id, $group_path);
    }

    public function addLdapGroup($name, $group_id, $full_path)
    {
        $modelLdap = new Default_Model_Ocs_Ldap();
