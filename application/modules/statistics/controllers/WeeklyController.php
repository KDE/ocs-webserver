 ...
 **/
class Statistics_WeeklyController extends Zend_Controller_Action
{
    ...
    public function ajaxAction()
    {
        ...
        $yearWeek = $this->request->getParam(self::YEARWEEK);

        $resultSet = $this->tableStatistics->getWeeklyStatistics($identifier, $yearWeek);
