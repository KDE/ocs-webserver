 ...
 **/
class Statistics_DailyController extends Zend_Controller_Action
{
    ...
    public function ajaxAction()
    {
        ...
        $day = $this->request->getParam(self::DAY);

        $resultSet = $this->tableStatistics->getDailyStatistics($identifier, $year, $month, $day);
