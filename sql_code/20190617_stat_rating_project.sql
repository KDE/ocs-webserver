ALTER TABLE project_rating
	ADD COLUMN score_test int(2) COMMENT 'vote up = 9 votedown = 3' AFTER score;

update project_rating set score_test = 9 where user_like = 1
  and created_at < '2019-05-14 10:00:00';
update project_rating set score_test = 3 where user_dislike = 1
  and created_at < '2019-05-14 10:00:00';

update project_rating set score_test = score
  where created_at > '2019-05-14 10:00:00';

update project_rating set score_test = round(((user_like-6)*9+(user_dislike-6)*3+10*5)/(user_like+user_dislike+10-12),2)
...
BEGIN
    ...
    (
      select project_id
        ...
        ,(user_like-6)*9+(user_dislike-6)*3 as totalscore_test
