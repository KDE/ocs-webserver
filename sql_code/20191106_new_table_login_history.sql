...
ALTER TABLE `login_history`
	ADD COLUMN `ipv4` VARCHAR(50) NULL DEFAULT NULL AFTER `ip_inet`,
	ADD COLUMN `ipv4_inet` VARBINARY(16) NULL DEFAULT NULL AFTER `ipv4`,
	ADD COLUMN `ipv6` VARCHAR(50) NULL DEFAULT NULL AFTER `ipv4_inet`,
	ADD COLUMN `ipv6_inet` VARBINARY(16) NULL DEFAULT NULL AFTER `ipv6`;
