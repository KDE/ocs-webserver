...
/**
 * @property IpAddressRange validator
 */
class IpAddressRangeTest extends TestCase
{
    public function testHostIpaddress()
    {
        ...
        $this->assertNotFalse($this->validator->isValid('http://localhost/metadata/v1'), "'localhost' is not rejected");
        if (false === $this->hasFailed()) {
            echo("'http://localhost/metadata/v1' => passed\n");
        }
    }
    ...
    {
        $this->validator = new IpAddressRange();
        parent::setUp();
    }
