...
class ConfigStoreTag implements InputFilterAwareInterface
{
    public $config_store_tag_id;
    public $store_id;
    public $tag_id;
    public $is_active;
    public $created_at;
    ...
    {
        $this->config_store_tag_id = !empty($data['config_store_tag_id']) ? $data['config_store_tag_id'] : null;
    ...
    {
        return [
            'config_store_tag_id' => $this->config_store_tag_id,
