...
class StatDownloadService extends BaseRepository implements StatDownloadServiceInterface
{
    ...
    public function getUserDownloads($member_id)
    {
        ...
        return $this->fetchAll($sql, array('member_id' => $member_id));
    }
    ...
    public function getUserDownloadsAndViewsForMonthAndSection($member_id, $yearmonth, $section_id = null)
    {
        $sql = "
                SELECT 
                    `micro_payout`.`yearmonth`,`micro_payout`.`project_id`,`micro_payout`.`project_category_id`
                    ,`project_category`.`dl_pling_factor` as `category_pling_factor`
                    ,`project_category`.`mv_pling_factor` as `category_pling_factor_mv`
                    ,`project_category`.`title`, `project`.`title`,`micro_payout`.`paypal_mail`,
                    ...
                    `micro_payout`.`section_id`, `micro_payout`.`section_payout_factor`, `micro_payout`.`org_factor`
        ...
        return $this->fetchAll($sql, array('member_id' => $member_id, 'yearmonth' => $yearmonth));
    }
    ...
    public function getUserDownloadsAndViewsForProject($member_id, $yearmonth, $section_id, $project_id)
    {
        $sql = "
                ...
                WHERE
                    `micro_payout`.`member_id` = :member_id
                    AND `micro_payout`.`yearmonth` = :yearmonth
                    AND `micro_payout`.`section_id` = :section_id
                    AND `micro_payout`.`project_id` = :project_id
    ...
    public function getUserAffiliatesForMonthAndSection($member_id, $yearmonth, $section_id = null)
    {
        ...
        $sql .= "  GROUP BY su.member_id, se.section_id, se.name, se.`order`, su.member_id, m.username , su.active_time
    ...
    public function getUserSectionsForDownloadAndViewsForMonth($member_id, $yearmonth)
    {
        ...
        $sql = "SELECT
                ...
                GROUP BY `m`.`section_id`, `m`.`section_id`, `s`.`name`, `s`.`order`, `m`.`section_payout_factor`
                ORDER BY `s`.`order`";
    ...
    public function getUserDownloadMonths($member_id, $year)
    {
        ...
        return $this->fetchAll($sql, array('member_id' => $member_id, 'year' => $year));
    ...
    public function getMonthEarn($member_id, $yyyymm)
    {
        ...
        $result = $this->fetchAll($sql, array('member_id' => $member_id, 'yyyymm' => $yyyymm));
    ...
    public function getLastMonthEarn($member_id)
    {
        ...
        $resultSet = $this->fetchAll($sql, array('member_id' => $member_id));
                ...
                FROM (
                    ...
                    FROM (
                        ...
                        SELECT 
                            ...
                            GROUP BY `micro_payout`.`yearmonth`, `micro_payout`.`project_id`,`micro_payout`.`section_id`,`member_payout`.`member_id`,`micro_payout`.`section_payout_factor`
                        ) `A`
                        GROUP BY `yearmonth`,`section_id`,`member_id`
