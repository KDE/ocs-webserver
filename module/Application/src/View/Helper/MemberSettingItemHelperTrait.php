 ...
 * defined by the MemberSettingItem component.
 ...
 * the MemberSettingItem component. However, multiple helper traits
 * from different Zend Framework components can be chained afterwards.
 *
 * @example @var \Laminas\View\Renderer\PhpRenderer|MemberSettingItem $this
 *
 * @method array memberSettingItem($setting_id, $use_cached_User = true)
 */
trait MemberSettingItemHelperTrait
{
}