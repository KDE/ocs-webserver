...
class BuildSearchTagUrl extends AbstractHelper
{
     ...
     * @return string
     */
    public function __invoke($searchstring, $action = 'find', $params = null, $withHost = false, $scheme = null)
    {
        ...
        return "{$host}/{$storeId}{$action}?search={$searchstring}&f=tags{$url_param}";
    }
