        ...
        <div className={"user-dropdown " + dropdownClass}>
          ...
          <ul className="dropdown-menu dropdown-menu-right">
            ...
            <li id="user-menu" className="buttons user-info-payout">
                <ul className="payout">
                  <li><a href={state.baseUrlStore + "/u/" + state.user.username + "/products"}><div className="icon"></div>My Products</a></li>
                  <li><a href={state.gitlabUrl+"/dashboard/projects"}><div className="icon"></div>My Projects</a></li>
                  <li><a href={gitlabLink}><div className="icon"></div>My Issues</a></li>
                </ul>
            </li>
