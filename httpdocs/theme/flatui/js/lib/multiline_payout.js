...
//Create axis
    ...
    var numofticks=20;
    if(dataset.length<numofticks)
    {
        numofticks = dataset.length;
    }  
    chartObj.xAxis  = d3.axisBottom(chartObj.xScale).ticks(numofticks).tickFormat(chartObj.xFormatter);    
