...
class CrawlerDetect
{
    ...
    public static function isCrawler($USER_AGENT)
    {
        ...
        $crawlers = array(
            ...
            array(
                'fantastic_search_engine_crawler',
            ...
            array('aipbot', 'aipbot'),
            array('BlackWidow', 'BlackWidow'),
            array('mailto:craftbot@yahoo.com', 'Bot\ mailto:craftbot@yahoo.com'),
            array('Bloggsi', 'Bloggsi'),
            array('ChinaClaw', 'ChinaClaw'),
            array('CHATCATCHER', 'CHATCATCHER'),
            array('CopyRightCheck', 'CopyRightCheck'),
            array('Custo', 'Custo'),
            array('EmailSiphon', 'EmailSiphon'),
            array('EmailWolf', 'EmailWolf'),
            array('NPBot', 'NPBot'),
            array('k2spider', 'k2spider'),
            array('HTTrack', 'HTTrack'),
            array('Teleport', 'Teleport'),
            array('Offline Explorer', 'Offline Explorer'),
            array('FlashGet', 'FlashGet'),
            array('GetRight', 'GetRight'),
            array('Image Stripper', 'Image\ Stripper'),
            array('Image Sucker', 'Image\ Sucker'),
        );
