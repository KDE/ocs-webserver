...
class PWGen
{
    ...
    /**
     * @param int $length Length $length of the generated password. Default: 8
     * @param bool $secure Generate $secure completely random, hard-to-memorize passwords. These should only
     ...
     * @param bool $numerals Include $numerals at least one number in the password. This is the default.
     * @param bool $capitalize Include $capitalize at least one capital letter in the password. This is the default.
     * @param bool $ambiguous Don $ambiguous 't use characters that could be confused by the user when printed,
     ...
     * @param bool $no_vovels $no -vowels    Generate random passwords that do not contain vowels or numbers that might be
     ...
     * @param bool $symbols Include $symbols at least one special character in the password.
     */
