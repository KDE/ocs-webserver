...
class Local_Payment_Dwolla_ResponseTransactionReturned implements Local_Payment_Dwolla_ResponseInterface
{
    ...
    {
        return $this->_rawResponse['SenderTransactionId'];
    }
    ...
    {
        return strtoupper($this->_rawResponse['Subtype']);
    }
