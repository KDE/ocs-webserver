...
class Local_Payment_Dwolla_UserData implements Local_Payment_UserDataInterface
{
    ...
    public function generateFromArray($array)
    {
        ...
        if (array_key_exists('dwolla_id', $array)) {
            $this->_payment_user_id = $array['dwolla_id'];
        }
