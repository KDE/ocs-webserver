...
class Default_Model_ProjectTest extends Zend_Test_PHPUnit_DatabaseTestCase
{
    ...
    {
        return $this->createFlatXMLDataSet(realpath(APPLICATION_PATH . "/../tests/_files/initialDataSet.xml"));
    }
    ...
    public function testDatabaseCanBeRead()
    {
        ...
        $expected = $this->createFlatXMLDataSet(APPLICATION_PATH . '/../tests/_files/selectDataSet.xml');
    ...
    public function getConnection()
    {
        if (null === $this->_connectionMock) {
            ...
            $this->bootstrap = new Local_Application(APPLICATION_ENV, Zend_Registry::get('configuration'), Zend_Registry::get('cache'));
