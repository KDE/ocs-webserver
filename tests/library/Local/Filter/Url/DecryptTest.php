...
class Local_Filter_Url_DecryptTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFilterUrl()
    {
        ...
        $result = $filter->filter('JTYwJURFJUYwJUI2JTlEJTI3JUU4JUMxdSVBRiVDNyVBRiUyRiU4RSUyMSUzQyUzQTclRkQlOUUlRjIlODYlRTlY');
        $this->assertEquals('/browse/page/2/cat/3', $result);
    }
